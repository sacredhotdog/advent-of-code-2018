...
class TestLogParser(unittest.TestCase):
    ...
    def test_valid_begin_shift_input_is_parsed_correctly(self):
        expected_date = date(1518, 3, 25)
        expected_time = time(0, 1)
    ...
    def test_valid_falls_asleep_input_is_parsed_correctly(self):
        expected_date = date(1619, 4, 26)
        expected_time = time(1, 2)
        expected_guard_id = 0
    ...
    def test_valid_wakes_up_input_is_parsed_correctly(self):
        expected_date = date(1518, 10, 11)
        expected_time = time(0, 27)
        expected_guard_id = 0
